...
class Circle_Trajectory
{
    ...
    public:
        ...
        void printf_result(drone_command::TrajectoryPoint& Circle_trajectory);

        //Circle_Trajectory Calculation [Input: time_from_start; Output: Circle_trajectory;]
        drone_command::TrajectoryPoint Circle_trajectory_generation(float time_from_start);
...
drone_command::TrajectoryPoint Circle_Trajectory::Circle_trajectory_generation(float time_from_start)
{
    drone_command::TrajectoryPoint Circle_trajectory;
    float omega;
    if( radius != 0)
    {
...
void Circle_Trajectory::printf_result(drone_command::TrajectoryPoint& Circle_trajectory)
{
