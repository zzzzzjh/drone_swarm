...
drone_command::ControlOutput pos_controller_UDE::pos_controller(
    ...
    const drone_command::TrajectoryPoint& _Reference_State, float dt)
{
    ...
    pos_error = drone_command_utils::cal_pos_error(_DroneState, _Reference_State);
    vel_error = drone_command_utils::cal_vel_error(_DroneState, _Reference_State);
    ...
    thrust_sp =  drone_command_utils::accelToThrust(accel_sp, Quad_MASS, tilt_max);
    throttle_sp = drone_command_utils::thrustToThrottle(thrust_sp);
